...
const JsTableSort = function(testingTableSortJS = false, domDocumentWindow = document) {
    ...
    function makeTableSortable(sortableTable) {
        ...
        for (let [columnIndex, th] of tableHeadHeaders.entries()) {
            if (!th.classList.contains("js-disable-sort")) {
    ...
    function makeEachColumnSortable(th, columnIndex, tableBody, sortableTable) {
        let desc = th.classList.contains("js-order-by-desc");
        ...
        th.addEventListener("click", function() {
            ...
            let isDataAttribute = th.classList.contains("js-data-sort");
            if (isDataAttribute) {
            ...
            let isRememberSort = sortableTable.classList.contains("js-remember-sort");
            if (!isRememberSort) {
